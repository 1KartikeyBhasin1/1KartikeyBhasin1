...
## 💻 Tech Stack:
[![My Skills](https://skillicons.dev/icons?i=py,java,js,html,css,react,nodejs,express,fastapi,mongodb,mysql,docker,git,linux,postman,supabase,bash,next,tailwind&perline=8)](https://skillicons.dev)
